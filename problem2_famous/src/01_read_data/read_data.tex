...
Read the top 2000 lines of the web.log data:
\begin{knitrout}
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
...
\end{verbatim}
\begin{alltt}
\hlkwd{write.csv}\hlstd{(numericSpamVisits,} \hlkwc{file}\hlstd{=}\hlstr{"out/spam_visits_numeric.csv"}\hlstd{,} \hlkwc{row.names}\hlstd{=}\hlnum{FALSE}\hlstd{)}
\end{alltt}
\end{kframe}
\end{knitrout}
