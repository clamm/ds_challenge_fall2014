...
Then load historic data into R. I set empty strings to \verb+NA+ (because of variables \verb+tail_number+ and \verb+cancellation_code+).
...
Specifically note the factor levels for the different variables\footnote{The number of levels matters if we would want to create a dummy variable for each level. With lots of levels the number of variables would be HUGE and so would be the sparsity of the design matrix.}.
We see that \verb+scheduled_departure_time+ and \verb+scheduled_arrival_time+ need to be reformatted to have for all observations values that are 4 characters long (assuming "100" means "0100" and thus a time of 01h00):
\begin{knitrout}
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
...
In addition we truncate the scheduled times to the hour:
\begin{knitrout}
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{trainDataTyped}\hlopt{$}\hlstd{scheduled_departure_time} \hlkwb{<-} \hlkwd{as.factor}\hlstd{(}
...
We also reformat the variables \verb+day_of_month+ and \verb+month+ (so that they're ordered automatically in graphs):
\begin{knitrout}
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
...
{\centering \includegraphics[width=.4\linewidth]{figure/plot-year-month-1} 
\includegraphics[width=.4\linewidth]{figure/plot-year-month-2} 
\includegraphics[width=.4\linewidth]{figure/plot-year-month-3} 
\includegraphics[width=.4\linewidth]{figure/plot-year-month-4} 
...
{\centering \includegraphics[width=.4\linewidth]{figure/plot-day-1} 
\includegraphics[width=.4\linewidth]{figure/plot-day-2} 
\includegraphics[width=.4\linewidth]{figure/plot-day-3} 
\includegraphics[width=.4\linewidth]{figure/plot-day-4} 
...
{\centering \includegraphics[width=.9\linewidth]{figure/plot-data-time-1} 
\includegraphics[width=.9\linewidth]{figure/plot-data-time-2} 
\includegraphics[width=.9\linewidth]{figure/plot-data-time-3} 
\includegraphics[width=.9\linewidth]{figure/plot-data-time-4} 
...
{\centering \includegraphics[width=.9\linewidth]{figure/plot-data-airline-1} 
\includegraphics[width=.9\linewidth]{figure/plot-data-airline-2} 
...
{\centering \includegraphics[width=.4\linewidth]{figure/plot-data-plane-1} 
\includegraphics[width=.4\linewidth]{figure/plot-data-plane-2} 
\includegraphics[width=.4\linewidth]{figure/plot-data-plane-3} 
\includegraphics[width=.4\linewidth]{figure/plot-data-plane-4} 
...
{\centering \includegraphics[width=1.0\linewidth]{figure/plot-data-airports-1} 
\includegraphics[width=1.0\linewidth]{figure/plot-data-airports-2} 
\includegraphics[width=1.0\linewidth]{figure/plot-data-airports-3} 
\includegraphics[width=1.0\linewidth]{figure/plot-data-airports-4} 
...
{\centering \includegraphics[width=.32\linewidth]{figure/continous-hist-1} 
\includegraphics[width=.32\linewidth]{figure/continous-hist-2} 
\includegraphics[width=.32\linewidth]{figure/continous-hist-3} 
...
{\centering \includegraphics[width=.32\linewidth]{figure/continous-median-1} 
\includegraphics[width=.32\linewidth]{figure/continous-median-2} 
\includegraphics[width=.32\linewidth]{figure/continous-median-3} 
