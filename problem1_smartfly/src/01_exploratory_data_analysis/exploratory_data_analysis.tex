...
{\centering \includegraphics[width=.4\linewidth]{figure/plot-data-date-1} 
\includegraphics[width=.4\linewidth]{figure/plot-data-date-2} 
\includegraphics[width=.4\linewidth]{figure/plot-data-date-3} 
\includegraphics[width=.4\linewidth]{figure/plot-data-date-4} 
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlcom{# truncate to hour (reduces to 21 levels)}
\hlstd{trainDataTyped}\hlopt{$}\hlstd{scheduled_departure_time_grouped} \hlkwb{<-} \hlkwd{as.factor}\hlstd{(}
...
\hlstd{trainDataTyped}\hlopt{$}\hlstd{scheduled_arrival_time_grouped} \hlkwb{<-} \hlkwd{as.factor}\hlstd{(}
