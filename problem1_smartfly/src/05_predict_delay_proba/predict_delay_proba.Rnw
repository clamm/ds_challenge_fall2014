...
load("../03_train_model/delayRF360k.RData")
@

<<predict-scheduled-flights>>=
library(randomForest)
predictionDelayRF360k <- predict(delayRF360k, rfPredictData, type="prob")
@


Save the prediction result:
<<save-prediction-result>>==
save(predictionDelayRF360k, file="../05_predict_delay_proba/rfPrediction.Rdata")
@
